...
<header class="ec-main-header" id="header">
    <nav class="navbar navbar-static-top navbar-expand-lg">
        ...
        <!-- search form -->
        <div class="search-form d-lg-inline-block d-none">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user-menu">
                    <button class="dropdown-toggle nav-link ec-drop" data-bs-toggle="dropdown"
                            aria-expanded="false">
                        <img style="height: 40px; object-fit: cover;" src="<sec:authentication property="principal.avatar"></sec:authentication>" class="user-image" alt="User Image" />
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right ec-dropdown-menu">
                        <!-- User image -->
                        <li class="dropdown-header">
                            <img style="height: 47px; object-fit: cover;" src="<sec:authentication property="principal.avatar"></sec:authentication>" class="img-circle" alt="User Image" />
                            <div class="d-inline-block">
                                <sec:authentication property="principal.fullName"></sec:authentication> <small class="pt-1"><sec:authentication property="principal.email"></sec:authentication></small>
                            </div>
                        </li>
                        <li>
                            <a href="/ekka/admin/profile">
