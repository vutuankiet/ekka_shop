                        ...
                        <div class="hero-container">
                            <div class="hero-counter">
                                <div class="hero-detail">
                                    <div class="logo">
                                        <img src="/user/assets/images/logo/dark-logo.png" alt="logo">
                                    </div>
                                    <h6 class="title" style="font-size: 20px">Thank you for shopping at <span>ekka</span> shop</h6>
                                    <!-- Newsletter -->
...
<script src="/user/assets/js/vendor/particles.min.js"></script>
<script src="/user/assets/js/vendor/app.js"></script>
...
<script src="/user/assets/js/plugins/coming-soon.js"></script>
