...
<head>
    ...
    <title>Ekka - Admin | Gender Category Editor.</title>
        ...
        <div class="ec-content-wrapper">
            <div class="content">
                <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="/ekka/admin/gender-category/list" type="button" class="btn btn-primary">Add Gender Category
                        </a>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="ec-cat-form">
                                    ...
                                    <f:form method="post" action="/ekka/admin/gender-category/update" modelAttribute="genderCategoryDto"
                                        ...
                                        <button type="submit" class="btn btn-primary btn-pill">Update Gender Category</button>
                                    ...
                                    <table id="responsive-data-table" class="table">
                                        ...
                                        <c:forEach items="${list}" var="genderCategory">
                                            <tr>
                                                ...
                                                <td>${genderCategory.created_at}</td>
                                                <td>
