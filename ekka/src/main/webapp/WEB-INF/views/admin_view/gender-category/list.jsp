...
<head>
    ...
    <title>Ekka - Admin | Gender Category.</title>
                ...
                <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="breadcrumbs"><span><a href="/ekka/admin">Home</a></span>
                            <span><i class="mdi mdi-chevron-right"></i></span> Gender Category</p>
                    </div>
                </div>
                        ...
                        <div class="ec-cat-list card card-default mb-24px">
                            <div class="card-body">
                                <div class="ec-cat-form">
                                    <h4>Add Gender Category</h4>
                                    <span style="color: red">${message}</span>

                                    <f:form method="post" action="/ekka/admin/gender-category/save" modelAttribute="genderCategoryDto"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label>Name Gender Category*</label>
                                        ...
                                        <button type="submit" class="btn btn-primary btn-pill">Create Gender Category</button>
                                    ...
                                    <table id="responsive-data-table" class="table">
                                        ...
                                        <c:forEach items="${list}" var="genderCategory">
                                            <tr>
                                                ...
                                                <td>${genderCategory.updated_at}</td>
                                                <td>
                                                    <div class="btn-group mb-1">
                                                        <button type="button"
                                                                class="btn btn-outline-success"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#infoUser-${genderCategory.id}">Info
                                                        </button>
                                                        <button type="button"
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                               href="/ekka/admin/gender-category/edit/${genderCategory.id}">Edit</a>
                                                            <c:if test="${genderCategory.state == 1}">
                                                                <f:form method="post"
