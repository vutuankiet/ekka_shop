...
<head>
    ...
    <title>Ekka - Admin | Category Editor.</title>
        ...
        <div class="ec-content-wrapper">
            <div class="content">
                <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="/ekka/admin/category/list" type="button" class="btn btn-primary">Add Category
                        </a>
                    </div>
                </div>
                        ...
                        <div class="ec-cat-list card card-default mb-24px">
                            <div class="card-body">
                                <div class="ec-cat-form">
                                    ...
                                    <f:form method="post" action="/ekka/admin/category/update" modelAttribute="categoryDto"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <f:select path="genderCategoryId" class="form-control"
                                                          required="required">
                                                    <c:forEach items="${listGender}" var="genderCategory">
                                                        <c:if test="${genderCategory.id == genderCategoryDto.id}">
                                                            <f:option class="form-control"
                                                                      value="${genderCategory.id}">${genderCategory.genderCategoryName}</f:option>
                                                        </c:if>
                                                    </c:forEach>
                                                    <c:forEach items="${listGender}" var="genderCategory">
                                                        <c:if test="${genderCategory.id != genderCategoryDto.id}">
                                    ...
                                    <table id="responsive-data-table" class="table">
                                        ...
                                        <c:forEach items="${list}" var="category">
                                            <tr>
                                                ...
                                                <td>${category.genderCategory.genderCategoryName}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group mb-1">
                                                        <button type="button"
                                                                ...
                                                                data-bs-target="#infoUser-${category.id}">Info
                                                        </button>
                                                        <button type="button"
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                               href="/ekka/admin/category/edit/${category.id}">Edit</a>
                                                            <c:if test="${category.state == 1}">
                                                                <f:form method="post"
                                                                        action="/ekka/admin/category/delete/${category.id}"
                                                            ...
                                                            <c:if test="${category.state == 0}">
                                                                <f:form method="post"
                                                                        action="/ekka/admin/category/restore/${category.id}"
                                                                        modelAttribute="categoryDto"
                                                                        enctype="multipart/form-data">
                                                                    <button class="dropdown-item pl-3"
                                                                            type="submit">Restore
                                            ...
                                            <!-- Info User Modal -->
                                            <div class="modal fade modal-add-contact" id="infoUser-${category.id}"
                                                 tabindex="-1"
                                                 role="dialog"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-lg"
                                                    ...
                                                    <div class="modal-content">
                                                                    ...
                                                                    <div class="card card-default">
                                                                        <div class="card-body text-center p-24px">
                                                                            <div class="image mb-3">
                                                                                <img src="${category.categoryLogo}"
                                                                                     class="img-fluid rounded-circle"
                                                                                     alt="Avatar Image"
                                                                                     style="width: 200px; height: 200px; object-fit: cover;">
                                                                            </div>

                                                                            <h5 class="card-title text-dark">${category.categoryName}</h5>
                                                                            <h5 class="card-title text-dark">( ${category.genderCategory.genderCategoryName} )</h5>
                                                                            <p class="item-count">535<span> items</span>
                                                                            </p>
                                                                            <div class="d-flex justify-content-center align-items-center">
                                                                                    ${category.state == 1 ? '<a class="btn btn-success my-3 mr-2" href="#">ACTIVE</a>' : '<a class="btn btn-danger my-3 mr-2" href="#">BLOCK</a>'}
                                                        ...
                                                        <div class="modal-footer px-4">
                                                            ...
                                                            <a href="/ekka/admin/category/edit/${category.id}">
