...
function ecCreateCookie(b, c, d) {
    var a = new Date;
    a.setTime(a.getTime() + 864e5 * d), document.cookie = b + "=" + c + "; expires=" + a.toGMTString()
}
...
function ecAccessCookie(e) {
    for (var c = e + "=", d = document.cookie.split(";"), a = 0; a < d.length; a++) {
        var b = d[a].trim();
...
!function (g) {
    "use strict";
    ecCheckCookie(), $(".clear-cach").on("click", function (a) {
        ...
        $("#ec-overlay").fadeOut("slow"), setTimeout(function () {
            // if ("file:" === window.location.protocol) {
            //     var a = '<div id="ec-direct-run" class="ec-direct-run"><div class="ec-direct-body"><h4>Template Running Directly</h4><p>As we seeing you are try to load template without Local | Live server. it will affect missed or lost content. Please try to use Local | Live Server. </p></div></div>';
            //     $("body").append(a)
            // }
        }, 3e3)
        ...
        var c, d = b * window.innerHeight / 100, g = window.innerHeight - d, h = window.innerWidth;

        function e(a) {
            a.style.animationDelay = a.dataset.animationDelay, a.style.animationDuration = a.dataset.animationDuration, a.classList.add(a.dataset.animation), a.dataset.animated = "true"
        }

        function f(b) {
            var a = b.getBoundingClientRect(), c = a.top + parseInt(b.dataset.animationOffset) || a.top,
                e = a.bottom - parseInt(b.dataset.animationOffset) || a.bottom, f = a.left, i = a.right;
            return c <= g && e >= d && f <= h && i >= 0
        }

        function i(c) {
            for (var b = c, a = 0, d = b.length; a < d; a++) !b[a].dataset.animated && f(b[a]) && e(b[a])
        }

        function a() {
            i(c = document.querySelectorAll("[data-animation]:not([data-animated])"))
        }

        return c = document.querySelectorAll("[data-animation]:not([data-animated])"), window.addEventListener("load", a, !1), window.addEventListener("scroll", () => i(c), {passive: !0}), window.addEventListener("resize", () => i(c), !1), {
            start: e,
            isElementOnScreen: f,
            update: a
        }
    }({offset: 20});
    var b, h = document.documentElement, i = window, n = i.scrollY || h.scrollTop, o = 0, p = 0;
    $(window).scrollTop(), document.getElementById("ec-main-menu-desk");
    var q, c, j, k, r = function () {
        (q = i.scrollY || h.scrollTop) > n ? o = 2 : q < n && (o = 1), o !== p && s(o, q), n = q
    }, s = function (a, b) {
    ...
    $(window).on("scroll", function () {
        ...
        $(this).toggleClass("active"), $(".dropdown_search").slideToggle("medium")
    }), $(".ec-sidebar-toggle").on("click", function () {
        $(".ec-side-cat-overlay").fadeIn(), $(".category-sidebar").addClass("ec-open")
    }), $(".ec-close").on("click", function () {
        $(".category-sidebar").removeClass("ec-open"), $(".ec-side-cat-overlay").fadeOut()
    }), $(".ec-side-cat-overlay").on("click", function () {
        $(".category-sidebar").removeClass("ec-open"), $(".ec-side-cat-overlay").fadeOut()
    }), $(document).ready(function () {
        $(".ec-sidebar-block .ec-sb-block-content ul li ul").addClass("ec-cat-sub-dropdown"), $(".ec-sidebar-block .ec-sidebar-block-item").on("click", function () {
            var a = $(this).closest(".ec-sb-block-content").find(".ec-cat-sub-dropdown");
            a.slideToggle("slow"), $(".ec-cat-sub-dropdown").not(a).slideUp("slow")
        })
    }), $(document).ready(function () {
        $(".ec-sidebar-slider-cat .ec-sb-pro-sl").slick({
            ...
            }, {breakpoint: 479, settings: {rows: 4, slidesToShow: 1, slidesToScroll: 1, dots: !1}}]
        })
    }), $(function () {
        ...
        $(".filter-sidebar-overlay").fadeIn(), $(".filter-sidebar").addClass("toggle-sidebar-swipe")
    }), $(".filter-cls-btn").on("click", function () {
        $(".filter-sidebar").removeClass("toggle-sidebar-swipe"), $(".filter-sidebar-overlay").fadeOut()
    }), $(".filter-sidebar-overlay").on("click", function () {
        $(".filter-sidebar").removeClass("toggle-sidebar-swipe"), $(".filter-sidebar-overlay").fadeOut()
    }), $(".ec-remove-wish").on("click", function () {
        $(this).parents(".pro-gl-content").remove(), 0 == $(".pro-gl-content").length && $(".ec-wish-rightside, .wish-empt").html('<p class="emp-wishlist-msg">Your wishlist is empty!</p>')
    }), $(".ec-remove-compare").on("click", function () {
        $(this).parents(".pro-gl-content").remove(), 0 == $(".pro-gl-content").length && $(".ec-compare-rightside").html('<p class="emp-wishlist-msg">Your Compare list is empty!</p>')
        ...
        $(".ec-side-cart-overlay").fadeIn(), $(c).addClass("ec-open"), a.parent().hasClass("mobile-menu-toggle") && (a.addClass("close"), $(".ec-side-cart-overlay").fadeOut())
    }), $(".ec-side-cart-overlay").on("click", function (a) {
        $(".ec-side-cart-overlay").fadeOut(), j.removeClass("ec-open"), k.find("a").removeClass("close")
    }), $(".ec-close").on("click", function (a) {
        a.preventDefault(), $(".ec-side-cart-overlay").fadeOut(), j.removeClass("ec-open"), k.find("a").removeClass("close")
    }), $("body").on("click", ".ec-pro-content .remove", function () {
        var a = $(".eccart-pro-items li").length;
        $(this).closest("li").remove(), 1 == a && $(".eccart-pro-items").html('<li><p class="emp-cart-msg">Your cart is empty!</p></li>');
        var b = $(".cart-count-lable").html();
        b--, $(".cart-count-lable").html(b), a--
    }), (b = $(".ec-menu-content, .overlay-menu")).find(".sub-menu").parent().prepend('<span class="menu-toggle"></span>'), b.on("click", "li a, .menu-toggle", function (b) {
        var a = $(this);
        ("#" === a.attr("href") || a.hasClass("menu-toggle")) && (b.preventDefault(), a.siblings("ul:visible").length ? (a.parent("li").removeClass("active"), a.siblings("ul").slideUp(), a.parent("li").find("li").removeClass("active"), a.parent("li").find("ul:visible").slideUp()) : (a.parent("li").addClass("active"), a.closest("li").siblings("li").removeClass("active").find("li").removeClass("active"), a.closest("li").siblings("li").find("ul:visible").slideUp(), a.siblings("ul").slideDown()))
    ...
    d.prepend('<div class="dec ec_qtybtn">-</div>'), d.append('<div class="inc ec_qtybtn">+</div>'), $("body").on("click", ".ec_qtybtn", function () {
        var a = $(this), b = a.parent().find("input").val();
        if ("+" === a.text()) var c = parseFloat(b) + 1; else if (b > 1) var c = parseFloat(b) - 1; else c = 1;
    ...
    $(".ec-main-menu ul li a").each(function () {
        if ("#" !== $(this).attr("href") && $(this).prop("href") == t) return $(".ec-main-menu a").parents("li, ul").removeClass("active"), $(this).parent("li").addClass("active"), !1
    });
    var u = $(".ec-pro-color, .ec-product-tab, .shop-pro-inner, .ec-new-product, .ec-releted-product, .ec-checkout-pro").find(".ec-opt-swatch");

    function v(a) {
        a.each(function () {
            var a = $(this), b = a.hasClass("ec-change-img");

            function c(c) {
                var a = c, d = a.find("a"), e = a.closest(".ec-product-inner").find(".ec-pro-image");
                return d.hasClass("loaded") || e.addClass("pro-loading"), a.find("a").addClass("loaded"), a.addClass("active").siblings().removeClass("active"), b && w(a), setTimeout(function () {
    ...
    function w(c) {
        var d = c.find(".ec-opt-clr-img"), a = d.attr("data-src"), e = d.attr("data-src-hover") || !1,
            f = c.closest(".ec-product-inner").find(".ec-pro-image"), h = f.find(".image img.main-image"),
    ...
    $(window).on("load", function () {
        ...
        function a(b) {
            var a = b, c = a.find("a").attr("data-old"), d = a.find("a").attr("data-new"),
                e = a.closest(".ec-pro-content").find(".old-price"),
                f = a.closest(".ec-pro-content").find(".new-price");
            e.text(c), f.text(d), a.addClass("active").siblings().removeClass("active")
        }
        ...
        $('img.svg_img[src$=".svg"]').each(function () {
            var a = $(this), b = a.attr("src"), c = a.prop("attributes");
            $.get(b, function (d) {
                var b = $(d).find("svg");
                b = b.removeAttr("xmlns:a"), $.each(c, function () {
        ...
        slidesToShow: 1,
        slidesToScroll: 1
    }), $("#ec-testimonial-slider").find(".slick-slide").each(function (a) {
        var b = $(this).find(".ec-test-img").html();
        $("#ec-testimonial-slider").find(".slick-dots").find("li:eq(" + a + ")").html(b)
        ...
        slidesToShow: 7,
        slidesToScroll: 1,
        responsive: [{breakpoint: 992, settings: {slidesToShow: 4, slidesToScroll: 1, dots: !1}}, {
            breakpoint: 600,
            settings: {slidesToScroll: 1, slidesToShow: 3}
        }, {breakpoint: 360, settings: {slidesToScroll: 1, slidesToShow: 2}}]
    }), $(document).ready(function () {
        $("footer .footer-top .ec-footer-widget .ec-footer-links").addClass("ec-footer-dropdown"), $(".ec-footer-heading").append("<div class='ec-heading-res'><i class='ecicon eci-angle-down'></i></div>"), $(".ec-footer-heading .ec-heading-res").click(function () {
            var a = $(this).closest(".footer-top .col-sm-12").find(".ec-footer-dropdown");
            a.slideToggle("slow"), $(".ec-footer-dropdown").not(a).slideUp("slow")
        })
        ...
        var b = $(".shop-pro-inner"), c = $(".pro-gl-content");
        a.preventDefault(), b.removeClass("list-view"), c.removeClass("width-100")
        ...
        var b = $(".shop-pro-inner"), c = $(".pro-gl-content");
        a.preventDefault(), b.removeClass("list-view-50"), c.removeClass("width-50")
    }), $(document).on("click", ".btn-list-50", function (a) {
        var b = $(".shop-pro-inner"), c = $(".pro-gl-content");
        a.preventDefault(), b.addClass("list-view-50"), c.addClass("width-50")
    }), $(document).ready(function () {
        $(".ec-shop-leftside .ec-sidebar-block .ec-sb-block-content,.ec-blogs-leftside .ec-sidebar-block .ec-sb-block-content,.ec-cart-rightside .ec-sidebar-block .ec-sb-block-content,.ec-checkout-rightside .ec-sidebar-block .ec-sb-block-content").addClass("ec-sidebar-dropdown"), $(".ec-sidebar-title").append("<div class='ec-sidebar-res'><i class='ecicon eci-angle-down'></i></div>"), $(".ec-sidebar-title .ec-sidebar-res").click(function () {
            var a = $(this).closest(".ec-shop-leftside .ec-sidebar-block,.ec-blogs-leftside .ec-sidebar-block,.ec-cart-rightside .ec-sidebar-block,.ec-checkout-rightside .ec-sidebar-wrap").find(".ec-sidebar-dropdown");
            a.slideToggle("slow"), $(".ec-sidebar-dropdown").not(a).slideUp("slow")
        })
    }), $(document).ready(function () {
        $(".ec-more-toggle").click(function () {
            "More Categories" == $(".ec-more-toggle #ec-more-toggle").text() ? ($(".ec-more-toggle #ec-more-toggle").text("Less Categories"), $(".ec-more-toggle").toggleClass("active"), $("#ec-more-toggle-content").slideDown()) : ($(".ec-more-toggle  #ec-more-toggle").text("More Categories"), $(".ec-more-toggle").removeClass("active"), $("#ec-more-toggle-content").slideUp())
        })
    }), $(document).ready(function () {
        ...
        $(".ec-faq-wrapper .ec-faq-block .ec-faq-content").addClass("ec-faq-dropdown"), $(".ec-faq-block .ec-faq-title ").click(function () {
            var a = $(this).closest(".ec-faq-wrapper .ec-faq-block").find(".ec-faq-dropdown");
            a.slideToggle("slow"), $(".ec-faq-dropdown").not(a).slideUp("slow")
        })
    }), $(document).ready(function () {
        $(".product_page .ec-sidebar-block .ec-sb-block-content ul li ul").addClass("ec-cat-sub-dropdown"), $(".product_page .ec-sidebar-block .ec-sidebar-block-item").click(function () {
            var a = $(this).closest(".ec-sb-block-content").find(".ec-cat-sub-dropdown");
            a.slideToggle("slow"), $(".ec-cat-sub-dropdown").not(a).slideUp("slow")
        })
    }), $(document).ready(function () {
    ...
    $(".cart-qty-plus-minus").append('<div class="ec_cart_qtybtn"><div class="inc ec_qtybtn">+</div><div class="dec ec_qtybtn">-</div></div>'), $(".cart-qty-plus-minus .ec_cart_qtybtn .ec_qtybtn").on("click", function () {
        var a = $(this), b = a.parent().parent().find("input").val();
        if ("+" === a.text()) var c = parseFloat(b) + 1; else if (b > 1) var c = parseFloat(b) - 1; else c = 1;
        ...
        $("button.add-to-cart").click(function () {
            ...
            $(this).hasClass("active") ? $(this).removeClass("active") : $(this).addClass("active"), $("#wishlist_toast").addClass("show"), setTimeout(function () {
    ...
    }, 1e4), $(".recent-close").click(function () {
        $(".recent-purchase").stop().slideToggle("slow")
    }), $(document).ready(function () {
        $(".ec-list").on("click", function () {
            var a = $(this).attr("data-number"), b = $(this).attr("data-message");
            /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? window.open("https://wa.me/" + a + "/?text=" + b, "-blank") : window.open("https://web.WhatsApp.com/send?phone=" + a + "&text=" + b, "-blank")
        }), $("ec-style1").launchBtn({openDuration: 400, closeDuration: 300})
    }), $.fn.launchBtn = function (e) {
        var a, b, f, g, h, i, c, d;
        a = $(".ec-button"), b = $(".ec-panel"), f = 0, g = $.extend({
            openDuration: 600,
            closeDuration: 200,
            rotate: !0
        }, e), h = function () {
            ...
            return 0 === f ? (g.rotate && $(this).removeClass("rotateBackward").toggleClass("rotateForward"), h(), f++) : (g.rotate && $(this).removeClass("rotateForward").toggleClass("rotateBackward"), i(), f--), a.preventDefault(), !1
        }, d = function (a) {
            a.stopPropagation()
        }, a.on("click", c), b.click(d), $(document).click(function () {
            i(), 1 === f && a.removeClass("rotateForward").toggleClass("rotateBackward"), f = 0
        })
        ...
        if (this.files && this.files[0]) {
            ...
            a.onload = function (b) {
                var a = c.parent().parent().children(".ec-preview").find(".ec-image-preview").attr("src", b.target.result);
                a.hide(), a.fadeIn(650)
            }, a.readAsDataURL(this.files[0])
        }
    }), $().appendTo($("body")), $(".bg-option-box").on("click", function (a) {
        return a.preventDefault(), $(this).hasClass("in-out") ? ($(".bg-switcher").stop().animate({right: "0px"}, 100), $(".color-option-box").not("in-out") && ($(".skin-switcher").stop().animate({right: "-163px"}, 100), $(".color-option-box").addClass("in-out")), $(".layout-option-box").not("in-out") && ($(".layout-switcher").stop().animate({right: "-163px"}, 100), $(".layout-option-box").addClass("in-out"))) : $(".bg-switcher").stop().animate({right: "-163px"}, 100), $(this).toggleClass("in-out"), !1
        ...
        return a.preventDefault(), $(this).hasClass("in-out") ? ($(".lang-switcher").stop().animate({right: "0px"}, 100), $(".color-option-box").not("in-out") && ($(".skin-switcher").stop().animate({right: "-163px"}, 100), $(".color-option-box").addClass("in-out")), $(".layout-option-box").not("in-out") && ($(".layout-switcher").stop().animate({right: "-163px"}, 100), $(".layout-option-box").addClass("in-out"))) : $(".lang-switcher").stop().animate({right: "-163px"}, 100), $(this).toggleClass("in-out"), !1
    }), $(".ec-tools-sidebar-toggle").on("click", function (a) {
        return a.preventDefault(), $(this).hasClass("in-out") ? ($(".ec-tools-sidebar").stop().animate({right: "0px"}, 100), $(".ec-tools-sidebar-overlay").fadeIn(), $(".ec-tools-sidebar-toggle").not("in-out") && ($(".ec-tools-sidebar").stop().animate({right: "-200px"}, 100), $(".ec-tools-sidebar-toggle").addClass("in-out")), $(".ec-tools-sidebar-toggle").not("in-out") && ($(".ec-tools-sidebar").stop().animate({right: "0"}, 100), $(".ec-tools-sidebar-toggle").addClass("in-out"), $(".ec-tools-sidebar-overlay").fadeIn())) : ($(".ec-tools-sidebar").stop().animate({right: "-200px"}, 100), $(".ec-tools-sidebar-overlay").fadeOut()), $(this).toggleClass("in-out"), !1
